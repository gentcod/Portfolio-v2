...
export const experienceData: ExperienceData = [
...

   {
      ...
      desc: 'I worked with an agency focused on E-Commerce Conversion Rate Optimization. I help review websites based on user interfaces and user experience. Evaluating the quality of the websites and how they are able to convey business purpose to their customers. Automating emailing and response to potential customers',
      color: '#f1c50e'
   }
]